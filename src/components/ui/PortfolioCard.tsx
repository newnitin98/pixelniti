...
export function PortfolioCard({ item, delay = 0 }: PortfolioCardProps) {
  return (
    ...
    >
      {/* Visual Panel */}
      <div className="relative h-48 bg-gradient-to-br from-primary/10 via-accent/5 to-primary/5 flex items-end p-4">
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#80808008_1px,transparent_1px),linear-gradient(to_bottom,#80808008_1px,transparent_1px)] bg-[size:24px_24px]" />
        <span className="relative z-10 inline-block px-3 py-1 rounded-full bg-primary/15 text-primary text-xs font-semibold border border-primary/20">
          {item.category}
        </span>
      </div>
